      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (_context.t0.response) {
            ...
            (0, _alerts.showAlert)('error', 'No response from server. Please check your network.');
          } else {
            (0, _alerts.showAlert)('An error occurred: ' + _context.t0.message);
          }
        case 10:
        case "end":
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:6969/api/v1/users/updatemypassword' : 'http://localhost:6969/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var stripe = Stripe('pk_test_51QrEAsLLD78oRxcmejV1nHLzfaAw9eiQZu4SqxxW0ohtI7wtKytGE9Z8zW9OIivKMG9cOfSVShn2Gbd4qCrbpW9E00YiY9xG2a');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return (0, _axios.default)("http://localhost:6969/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
document.addEventListener('DOMContentLoaded', function () {
  var updateForm = document.querySelector('.form-user-data'); // Correct form class
